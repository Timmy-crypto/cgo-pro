...
// add extra api
func (service *RpcService) AddApis(apis []rpc.API) {
...
func (service *RpcService) Start() error {
	...
	if err := service.startHTTP(service.httpEndpoint, service.apis, []string{}, service.allowHosts, service.allowHosts); err != nil {
		log.Info("start http error","err",err)
		service.Stop()
		return err
	}
	...
	if err := service.startWS(service.wsEndpoint, service.apis, []string{}, service.allowHosts, true); err != nil {
		log.Info("start webSocket error","err",err)
		service.Stop()
		return err
	}
	return nil
...
func (service *RpcService) startInProc(apis []rpc.API) error {
...
func (service *RpcService) stopInProc() {
...
func (service *RpcService) startHTTP(endpoint string, apis []rpc.API, modules []string, cors []string, vhosts []string) error {
...
func (service *RpcService) stopHTTP() {
...
func (service *RpcService) startWS(endpoint string, apis []rpc.API, modules []string, wsOrigins []string, exposeAll bool) error {
...
func (service *RpcService) stopWS() {
